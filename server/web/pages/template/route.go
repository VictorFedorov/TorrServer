...
func RouteWebPages(route gin.IRouter) {
	...
	route.GET("/static/css/2.3eababf4.chunk.css", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticcss23eababf4chunkcss))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "text/css; charset=utf-8", Staticcss23eababf4chunkcss)
	})

	route.GET("/static/css/2.3eababf4.chunk.css.map", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticcss23eababf4chunkcssmap))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "application/json", Staticcss23eababf4chunkcssmap)
	})

	route.GET("/static/css/main.c718f56f.chunk.css", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticcssmainc718f56fchunkcss))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "text/css; charset=utf-8", Staticcssmainc718f56fchunkcss)
	})

	route.GET("/static/css/main.c718f56f.chunk.css.map", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticcssmainc718f56fchunkcssmap))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "application/json", Staticcssmainc718f56fchunkcssmap)
	})

	route.GET("/static/js/2.79119296.chunk.js", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjs279119296chunkjs))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "text/javascript; charset=utf-8", Staticjs279119296chunkjs)
	})

	route.GET("/static/js/2.79119296.chunk.js.LICENSE.txt", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjs279119296chunkjsLICENSEtxt))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "text/plain; charset=utf-8", Staticjs279119296chunkjsLICENSEtxt)
	})

	route.GET("/static/js/2.79119296.chunk.js.map", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjs279119296chunkjsmap))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "application/json", Staticjs279119296chunkjsmap)
	})

	route.GET("/static/js/main.1858ed4e.chunk.js", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjsmain1858ed4echunkjs))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "text/javascript; charset=utf-8", Staticjsmain1858ed4echunkjs)
	})

	route.GET("/static/js/main.1858ed4e.chunk.js.map", func(c *gin.Context) {
		etag := fmt.Sprintf("%x", md5.Sum(Staticjsmain1858ed4echunkjsmap))
		c.Header("Cache-Control", "public, max-age=31536000")
		c.Header("ETag", etag)
		c.Data(200, "application/json", Staticjsmain1858ed4echunkjsmap)
	})
